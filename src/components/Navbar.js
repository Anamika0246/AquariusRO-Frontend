    ...
    <nav className="fixed w-full z-50 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm shadow-lg">
      <div className="container mx-auto px-8 sm:px-12">
        <div className="flex justify-between h-16">
          ...
          <div className="flex items-center space-x-4">
            <button
              onClick={toggleTheme}
              className="p-2 rounded-md text-gray-400 hover:text-gray-500 dark:text-gray-500 dark:hover:text-white transition duration-300"
            >
              {themeIcon}
            </button>
            <Link
      ...
      {isOpen && (
        <div className="sm:hidden">
          ...
          <div className="fixed right-0 top-0 max-w-xs w-full h-full bg-white dark:bg-gray-800 shadow-xl transform transition-transform duration-300 ease-in-out" style={{ transform: isOpen ? 'translateX(0)' : 'translateX(100%)' }}>
            <div className="p-8">
              ...
              <nav className="space-y-4">
                <Link
                  to="/"
                  className="block px-3 py-2 rounded-md text-base font-medium text-gray-900 dark:text-white hover:text-gray-700 dark:hover:text-gray-300 transition duration-300"
                  onClick={() => setIsOpen(false)}
                >
                  Home
                </Link>
